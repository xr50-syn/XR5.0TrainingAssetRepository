...
namespace XR5_0TrainingRepo.Controllers
{
    ...
    public class asset_managementController : ControllerBase
    {
	    ...
	    if (Asset.ResourceName!=null) {
	    	var Resource = _context.Resources.FirstOrDefault( r => r.ResourceName.Equals(Asset.ResourceName) && r.TrainingName.Equals(Asset.TrainingName) &&AppName.Equals(Asset.AppName));                                                              Resource.AssetList.Add(Asset.AssetId);                                                             
	    }
